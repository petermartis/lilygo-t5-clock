...
#define BATT_ICON_W 60
#define BATT_ICON_H 30
...
void getBatteryLevel(bool epdPoweredOn = false);
...
void redrawClock() {
	...
	// Draw battery icon below time, right-aligned with last digit
	int x1, y1, tw, th;
	int xx = CLOCK_X, yy = CLOCK_Y;
	get_text_bounds(&currentFont, tod, &xx, &yy, &x1, &y1, &tw, &th, NULL);
	int battX = CLOCK_X + tw - BATT_ICON_W;  // Right-align with time
	int battY = CLOCK_Y + 6;                 // 6px below time baseline
...
void drawClock() {
	...
	// Draw battery icon if level changed
	if (_drawBattery) {
		int x1, y1, tw, th;
		int xx = CLOCK_X, yy = CLOCK_Y;
...
// IMPORTANT: On ESP32-S3, GPIO 14 is ADC2 which conflicts with WiFi.
// Battery must be read when WiFi is OFF and EPD power is ON.
// The voltage divider is connected to the EPD power rail (POWER_EN).
void getBatteryLevel(bool epdPoweredOn) {
	// If EPD not already powered, we need to power it on to read battery
	...
	// Voltage calculation for ESP32-S3 with voltage divider
	// Default vref is ~1100mV, using 2.0 multiplier for voltage divider
...
// Battery icon bitmaps (60x30 pixels, 4bpp grayscale)
// Format: 4 bits per pixel, 0x0=black, 0xF=white
// Each row is 30 bytes (60 pixels / 2)
// Layout: 48px body + 6px tip + 6px padding
// Body has 2px outline, interior has 4 segments of 9px with 2px gaps
// Tip: 6px wide, 12px tall, centered vertically (rows 9-20)

// Row patterns (30 bytes each):
// OUTLINE: body all black, rest white
#define BATT_ROW_OUTLINE \
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, \
	0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF

// Empty interior, no tip
#define BATT_ROW_EMPTY_NO_TIP \
	0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF

// Empty interior, with tip
#define BATT_ROW_EMPTY_WITH_TIP \
	0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, \
	0x00,0x00,0x00,0xFF,0xFF,0xFF

// 1 segment filled, no tip (seg1: bytes 1-5)
#define BATT_ROW_SEG1_NO_TIP \
	0x00,0xF0,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF

// 1 segment filled, with tip
#define BATT_ROW_SEG1_WITH_TIP \
	0x00,0xF0,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, \
	0x00,0x00,0x00,0xFF,0xFF,0xFF

// 2 segments filled, no tip
#define BATT_ROW_SEG2_NO_TIP \
	0x00,0xF0,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x0F, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF

// 2 segments filled, with tip
#define BATT_ROW_SEG2_WITH_TIP \
	0x00,0xF0,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x0F, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, \
	0x00,0x00,0x00,0xFF,0xFF,0xFF

// 3 segments filled, no tip
#define BATT_ROW_SEG3_NO_TIP \
	0x00,0xF0,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x0F, \
	0xF0,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF

// 3 segments filled, with tip
#define BATT_ROW_SEG3_WITH_TIP \
	0x00,0xF0,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x0F, \
	0xF0,0x00,0x00,0x00,0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00, \
	0x00,0x00,0x00,0xFF,0xFF,0xFF

// 4 segments filled, no tip
#define BATT_ROW_SEG4_NO_TIP \
	0x00,0xF0,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x0F, \
	0xF0,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x0F,0x00, \
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF

// 4 segments filled, with tip
#define BATT_ROW_SEG4_WITH_TIP \
	0x00,0xF0,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x0F, \
	0xF0,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x0F,0x00, \
	0x00,0x00,0x00,0xFF,0xFF,0xFF

static const uint8_t BATT_ICON_0[] = {
	BATT_ROW_OUTLINE, BATT_ROW_OUTLINE,                         // rows 0-1: top outline
	BATT_ROW_EMPTY_NO_TIP, BATT_ROW_EMPTY_NO_TIP,               // rows 2-3
	BATT_ROW_EMPTY_NO_TIP, BATT_ROW_EMPTY_NO_TIP,               // rows 4-5
	BATT_ROW_EMPTY_NO_TIP, BATT_ROW_EMPTY_NO_TIP,               // rows 6-7
	BATT_ROW_EMPTY_NO_TIP,                                       // row 8
	BATT_ROW_EMPTY_WITH_TIP, BATT_ROW_EMPTY_WITH_TIP,           // rows 9-10: tip starts
	BATT_ROW_EMPTY_WITH_TIP, BATT_ROW_EMPTY_WITH_TIP,           // rows 11-12
	BATT_ROW_EMPTY_WITH_TIP, BATT_ROW_EMPTY_WITH_TIP,           // rows 13-14
	BATT_ROW_EMPTY_WITH_TIP, BATT_ROW_EMPTY_WITH_TIP,           // rows 15-16
	BATT_ROW_EMPTY_WITH_TIP, BATT_ROW_EMPTY_WITH_TIP,           // rows 17-18
	BATT_ROW_EMPTY_WITH_TIP, BATT_ROW_EMPTY_WITH_TIP,           // rows 19-20: tip ends
	BATT_ROW_EMPTY_NO_TIP,                                       // row 21
	BATT_ROW_EMPTY_NO_TIP, BATT_ROW_EMPTY_NO_TIP,               // rows 22-23
	BATT_ROW_EMPTY_NO_TIP, BATT_ROW_EMPTY_NO_TIP,               // rows 24-25
	BATT_ROW_EMPTY_NO_TIP, BATT_ROW_EMPTY_NO_TIP,               // rows 26-27
	BATT_ROW_OUTLINE, BATT_ROW_OUTLINE,                         // rows 28-29: bottom outline
};

static const uint8_t BATT_ICON_1[] = {
	BATT_ROW_OUTLINE, BATT_ROW_OUTLINE,
	BATT_ROW_EMPTY_NO_TIP, BATT_ROW_SEG1_NO_TIP,
	BATT_ROW_SEG1_NO_TIP, BATT_ROW_SEG1_NO_TIP,
	BATT_ROW_SEG1_NO_TIP, BATT_ROW_SEG1_NO_TIP,
	BATT_ROW_SEG1_NO_TIP,
	BATT_ROW_SEG1_WITH_TIP, BATT_ROW_SEG1_WITH_TIP,
	BATT_ROW_SEG1_WITH_TIP, BATT_ROW_SEG1_WITH_TIP,
	BATT_ROW_SEG1_WITH_TIP, BATT_ROW_SEG1_WITH_TIP,
	BATT_ROW_SEG1_WITH_TIP, BATT_ROW_SEG1_WITH_TIP,
	BATT_ROW_SEG1_WITH_TIP, BATT_ROW_SEG1_WITH_TIP,
	...
	BATT_ROW_SEG1_NO_TIP, BATT_ROW_SEG1_NO_TIP,
	BATT_ROW_SEG1_NO_TIP, BATT_ROW_SEG1_NO_TIP,
	BATT_ROW_SEG1_NO_TIP, BATT_ROW_EMPTY_NO_TIP,
	BATT_ROW_OUTLINE, BATT_ROW_OUTLINE,
};

static const uint8_t BATT_ICON_2[] = {
	BATT_ROW_OUTLINE, BATT_ROW_OUTLINE,
	BATT_ROW_EMPTY_NO_TIP, BATT_ROW_SEG2_NO_TIP,
	BATT_ROW_SEG2_NO_TIP, BATT_ROW_SEG2_NO_TIP,
	BATT_ROW_SEG2_NO_TIP, BATT_ROW_SEG2_NO_TIP,
	BATT_ROW_SEG2_NO_TIP,
	BATT_ROW_SEG2_WITH_TIP, BATT_ROW_SEG2_WITH_TIP,
	BATT_ROW_SEG2_WITH_TIP, BATT_ROW_SEG2_WITH_TIP,
	BATT_ROW_SEG2_WITH_TIP, BATT_ROW_SEG2_WITH_TIP,
	BATT_ROW_SEG2_WITH_TIP, BATT_ROW_SEG2_WITH_TIP,
	BATT_ROW_SEG2_WITH_TIP, BATT_ROW_SEG2_WITH_TIP,
	...
	BATT_ROW_SEG2_NO_TIP, BATT_ROW_SEG2_NO_TIP,
	BATT_ROW_SEG2_NO_TIP, BATT_ROW_SEG2_NO_TIP,
	BATT_ROW_SEG2_NO_TIP, BATT_ROW_EMPTY_NO_TIP,
	BATT_ROW_OUTLINE, BATT_ROW_OUTLINE,
};

static const uint8_t BATT_ICON_3[] = {
	BATT_ROW_OUTLINE, BATT_ROW_OUTLINE,
	BATT_ROW_EMPTY_NO_TIP, BATT_ROW_SEG3_NO_TIP,
	BATT_ROW_SEG3_NO_TIP, BATT_ROW_SEG3_NO_TIP,
	BATT_ROW_SEG3_NO_TIP, BATT_ROW_SEG3_NO_TIP,
	BATT_ROW_SEG3_NO_TIP,
	BATT_ROW_SEG3_WITH_TIP, BATT_ROW_SEG3_WITH_TIP,
	BATT_ROW_SEG3_WITH_TIP, BATT_ROW_SEG3_WITH_TIP,
	BATT_ROW_SEG3_WITH_TIP, BATT_ROW_SEG3_WITH_TIP,
	BATT_ROW_SEG3_WITH_TIP, BATT_ROW_SEG3_WITH_TIP,
	BATT_ROW_SEG3_WITH_TIP, BATT_ROW_SEG3_WITH_TIP,
	...
	BATT_ROW_SEG3_NO_TIP, BATT_ROW_SEG3_NO_TIP,
	BATT_ROW_SEG3_NO_TIP, BATT_ROW_SEG3_NO_TIP,
	BATT_ROW_SEG3_NO_TIP, BATT_ROW_EMPTY_NO_TIP,
	BATT_ROW_OUTLINE, BATT_ROW_OUTLINE,
};

static const uint8_t BATT_ICON_4[] = {
	BATT_ROW_OUTLINE, BATT_ROW_OUTLINE,
	BATT_ROW_EMPTY_NO_TIP, BATT_ROW_SEG4_NO_TIP,
	BATT_ROW_SEG4_NO_TIP, BATT_ROW_SEG4_NO_TIP,
	BATT_ROW_SEG4_NO_TIP, BATT_ROW_SEG4_NO_TIP,
	BATT_ROW_SEG4_NO_TIP,
	BATT_ROW_SEG4_WITH_TIP, BATT_ROW_SEG4_WITH_TIP,
	BATT_ROW_SEG4_WITH_TIP, BATT_ROW_SEG4_WITH_TIP,
	BATT_ROW_SEG4_WITH_TIP, BATT_ROW_SEG4_WITH_TIP,
	BATT_ROW_SEG4_WITH_TIP, BATT_ROW_SEG4_WITH_TIP,
	BATT_ROW_SEG4_WITH_TIP, BATT_ROW_SEG4_WITH_TIP,
	...
	BATT_ROW_SEG4_NO_TIP, BATT_ROW_SEG4_NO_TIP,
	BATT_ROW_SEG4_NO_TIP, BATT_ROW_SEG4_NO_TIP,
	BATT_ROW_SEG4_NO_TIP, BATT_ROW_EMPTY_NO_TIP,
	BATT_ROW_OUTLINE, BATT_ROW_OUTLINE,
};
...
void drawBatteryIcon(int x, int y, uint8_t level, bool clear) {
	// Battery icon: 60x30 pixels using bitmap
	...
	// Draw battery icon using epd_draw_image
	Rect_t iconArea = {
		.x = x,
		.y = y,
		.width = BATT_ICON_W,
	...
	epd_draw_image(iconArea, (uint8_t*)BATT_ICONS[level], BLACK_ON_WHITE);
}
